...
class Gericht
{
   ...
   /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Kategori", inversedBy="gericht")
     */
    private $kategorie;
    ...
    public function getKategorie(): ?Kategori
    {
        return $this->kategorie;
    }

    public function setKategorie(?Kategori $kategorie): self
    {
